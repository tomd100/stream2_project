...
bd_songs_collection = 'bob_dylan_songs';
top_songs_collection = 'top_30_songs';
...
def get_bob_dylan_songs():
    with MongoClient(mongodb_uri) as conn:
        collection = conn[dbs_name][bd_songs_collection]
...
def get_top_30_songs():
    with MongoClient(mongodb_uri) as conn:
        collection = conn[dbs_name][top_songs_collection]
